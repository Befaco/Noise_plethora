...
class RwalkVarWave: public Plugin {
public:

  RwalkVarWave()
  : patchCord1(waveform1, 0, waveformMod1, 0)
  {}
    ~RwalkVarWave() override {}

    // delete copy constructors
    RwalkVarWave(const RwalkVarWave&) = delete;
    RwalkVarWave& operator=(const RwalkVarWave&) = delete;
  ...
  REGISTER_PLUGIN(RwalkVarWave); // this is important, so that we can include the plugin in a bank
